...
- Generated UTC: `2026-09-01T00:36:00Z`
- Run ID: `20260901T002849Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| aguayluz-pr | `e2c19411617b` | `STARTUP_SETUP_COMPLETE` | `PRODUCT_COMPLETE` | `True` | `PASS` | `PASS` | `PASS` | `PASS` |
...
| thehub-pr | `a753ad50b82f` | `STARTUP_SETUP_COMPLETE` | `PRODUCT_COMPLETE` | `None` | `PASS` | `PASS` | `PASS` | `PASS` |
