...
- Generated UTC: `2026-09-01T00:08:41Z`
- Run ID: `20260901T000009Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| aguayluz-pr | `aaf1d79df1bc` | `STARTUP_SETUP_COMPLETE` | `PRODUCT_COMPLETE` | `True` | `PASS` | `PASS` | `PASS` | `PASS` |
| centinelas-pr | `6adbba5bcdc2` | `STARTUP_SETUP_COMPLETE` | `PRODUCT_COMPLETE` | `True` | `PASS` | `PASS` | `PASS` | `PASS` |
| moneysweep-pr | `51e283c40179` | `FAIL` | `BLOCKED_FOR_PRODUCT_COMPLETION` | `False` | `PASS` | `FAIL` | `PASS` | `PASS` |
| ovnis-pr | `b02ac5094852` | `STARTUP_SETUP_COMPLETE` | `PRODUCT_COMPLETE` | `True` | `PASS` | `PASS` | `PASS` | `PASS` |
| skywatcher-pr | `e0041094d02c` | `STARTUP_SETUP_COMPLETE` | `BLOCKED_FOR_PRODUCT_COMPLETION` | `False` | `PASS` | `PASS` | `PASS` | `PASS` |
| spiderweb-pr | `533fdde554e1` | `STARTUP_SETUP_COMPLETE` | `PRODUCT_COMPLETE` | `True` | `PASS` | `PASS` | `PASS` | `PASS` |
| thehub-pr | `bfc8f488c720` | `STARTUP_SETUP_COMPLETE` | `PRODUCT_COMPLETE` | `None` | `PASS` | `PASS` | `PASS` | `PASS` |

## Startup/Setup Blockers

- `moneysweep-pr`: `FAIL` - test_suite:FAIL

## Product Completion Blockers

- `moneysweep-pr`: `BLOCKED_FOR_PRODUCT_COMPLETION` - startup_setup_state:FAIL, manual-source Tranche B not materialized (hud_drgr_authorized, prasa, oficina_contralor, pr_cabilderos await operator file drops), cor3 live endpoints return no data (portal likely requires JavaScript rendering); manual CSV export fallback documented, PR-gov scraper-needed queue: 13 of 15 sources promoted to api_producer; 2 true stubs remain (hacienda_sut_ivu, pr_act_154_excise), PROPUBLICA_API_KEY not supplied (nonprofits adapter), source-count wording must stay reconciled to reports/materialization_readiness.json truth, MANIFEST_READY_FOR_HUB_LIVE_EXECUTION_FALSE
