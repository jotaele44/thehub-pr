...
export const ONLINE_SOURCE_CATALOG = Object.freeze([
  Object.freeze({ sourceId: 'pr-sige-municipios', providerId: 'pr-sige', label: 'Municipios', category: 'boundaries', protocol: 'arcgis-feature-layer-geojson', endpoint: 'https://sige.pr.gov/server/rest/services/MIPR/LimitesAdministrativos_v10/FeatureServer/0', transport: 'direct-or-proxy', sourceNativeCrs: 'EPSG:32161', outputCrs: 'EPSG:4326', stableIdField: 'OBJECTID', expectedGeometryTypes: Object.freeze(['Polygon', 'MultiPolygon']), expectedFeatureCount: 78, pageSize: 1000, runtimeStatus: 'IMPLEMENTED', certification: 'LIVE_PASS_2026_08_29' }),
  Object.freeze({ sourceId: 'pr-sige-represas', providerId: 'pr-sige', label: 'Represas', category: 'hydro-infrastructure', protocol: 'arcgis-feature-layer-geojson', endpoint: `${PR_SIGE_INFRASTRUCTURE}/1`, transport: 'direct-or-proxy', sourceNativeCrs: 'EPSG:32161', outputCrs: 'EPSG:4326', stableIdField: 'OBJECTID_1', expectedGeometryTypes: Object.freeze(['Point']), expectedFeatureCount: 35, pageSize: 1000, runtimeStatus: 'IMPLEMENTED', certification: 'LIVE_PASS_2026_08_29' }),
  Object.freeze({ sourceId: 'pr-sige-aeropuertos', providerId: 'pr-sige', label: 'Aeropuertos', category: 'transport', protocol: 'arcgis-feature-layer-geojson', endpoint: `${PR_SIGE_INFRASTRUCTURE}/17`, transport: 'direct-or-proxy', sourceNativeCrs: 'EPSG:32161', outputCrs: 'EPSG:4326', stableIdField: 'OBJECTID_1', expectedGeometryTypes: Object.freeze(['Point']), expectedFeatureCount: 14, pageSize: 1000, runtimeStatus: 'IMPLEMENTED', certification: 'LIVE_PASS_2026_08_29' }),
  Object.freeze({ sourceId: 'pr-sige-helipuertos', providerId: 'pr-sige', label: 'Helipuertos', category: 'transport', protocol: 'arcgis-feature-layer-geojson', endpoint: `${PR_SIGE_INFRASTRUCTURE}/18`, transport: 'direct-or-proxy', sourceNativeCrs: 'EPSG:32161', outputCrs: 'EPSG:4326', stableIdField: 'OBJECTID_1', expectedGeometryTypes: Object.freeze(['Point']), expectedFeatureCount: 6, pageSize: 1000, runtimeStatus: 'IMPLEMENTED', certification: 'LIVE_PASS_2026_08_29' }),

  Object.freeze({ sourceId: 'pr-geodata-barrios-2015-simpl', providerId: 'pr-geodata-wfs', label: 'Barrios 2015 simplificados · displaced candidate', category: 'boundaries', protocol: 'wfs', endpoint: 'http://geoserver2.pr.gov/geoserver/pr_geodata/wfs', transport: 'proxy-required', typeName: 'pr_geodata:g03_legales_barrios_2015_simpl_5m', stableIdField: 'gid', expectedGeometryTypes: Object.freeze(['Polygon', 'MultiPolygon']), outputCrs: 'EPSG:4326', pageSize: 1000, runtimeStatus: 'SUPERSEDED_BAD_LIVE_BINDING', certification: 'SUPERSEDED' }),
  Object.freeze({ sourceId: 'pr-geodata-barrios-2015', providerId: 'pr-geodata-wfs', label: 'Barrios 2015', category: 'boundaries', protocol: 'wfs', endpoint: 'http://geoserver2.pr.gov/geoserver/pr_geodata/wfs', transport: 'proxy-required', typeName: 'pr_geodata:g03_legales_barrios_2015', stableIdField: 'gid', expectedGeometryTypes: Object.freeze(['Polygon', 'MultiPolygon']), outputCrs: 'EPSG:4326', pageSize: 1000, runtimeStatus: 'IMPLEMENTED', certification: 'PROVISIONAL_PROVIDER_RUNTIME' }),
