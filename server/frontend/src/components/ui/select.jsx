 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SelectPrimitive.Trigger>>} ref
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SelectPrimitive.ScrollUpButton>>} ref
 */ ({ className, ...props }, ref) => (
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SelectPrimitive.ScrollDownButton>>} ref
 */ ({ className, ...props }, ref) => (
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SelectPrimitive.Content>>} ref
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SelectPrimitive.Label>>} ref
 */ ({ className, ...props }, ref) => (
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SelectPrimitive.Item>>} ref
 */ ({ className, children, ...props }, ref) => (
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SelectPrimitive.Separator>>} ref
 */ ({ className, ...props }, ref) => (
