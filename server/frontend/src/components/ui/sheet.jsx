 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SheetPrimitive.Overlay>>} ref
 */ ({ className, ...props }, ref) => (
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SheetPrimitive.Content>>} ref
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SheetPrimitive.Title>>} ref
 */ ({ className, ...props }, ref) => (
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof SheetPrimitive.Description>>} ref
 */ ({ className, ...props }, ref) => (
