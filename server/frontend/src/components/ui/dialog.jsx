 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof DialogPrimitive.Overlay>>} ref
 */ ({ className, ...props }, ref) => (
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof DialogPrimitive.Content>>} ref
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof DialogPrimitive.Title>>} ref
 */ ({ className, ...props }, ref) => (
 ...
 * @param {React.ForwardedRef<React.ComponentRef<typeof DialogPrimitive.Description>>} ref
 */ ({ className, ...props }, ref) => (
