...
- Preferred: open a private [GitHub Security Advisory]({{REPO_URL}}/security/advisories/new)
  for this repository.
...
This policy covers the `{{PROGRAM_ID}}` source code and its CI/CD configuration.
